    ...
    <>
      ...
      <section style={{
        ...
        <div className="container" style={{ position: 'relative', zIndex: 1, maxWidth: '800px', margin: '0 auto' }}>
          <p className="section-subtitle" style={{ animation: 'fadeInUp 0.8s ease-out' }}>{storeName}</p>
          <h1 className="section-title" style={{ fontSize: '3.5rem', marginBottom: '24px', animation: 'fadeInUp 1s ease-out' }}>
            Luxury, Naturally Crafted.
          </h1>
          <p style={{ color: 'var(--color-text-secondary)', fontSize: '1.2rem', lineHeight: 1.6, animation: 'fadeInUp 1.2s ease-out' }}>
      ...
      <section className="container" style={{ padding: '80px 24px', maxWidth: '1000px', margin: '0 auto' }}>
        ...
        {/* Our Commitment */}
        <div className="glass-card" style={{ padding: '60px 40px', textAlign: 'center', borderRadius: '12px', marginBottom: '80px' }}>
