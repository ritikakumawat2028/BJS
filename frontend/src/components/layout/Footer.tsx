          ...
          <div className="footer__grid">
            ...
            <div className="footer__brand">
              ...
              <div className="footer__social">
                {settings?.instagram && (
                  <a href={settings.instagram} className="footer__social-link" aria-label="Instagram" target="_blank" rel="noopener noreferrer">
            ...
            <div className="footer__col">
              ...
              <ul className="footer__links">
                {(settings?.store_phone || '+91 9825268872') && (
                  <li>
                    <a href={`tel:${settings?.store_phone || '+91 9825268872'}`} className="footer__link" style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                ...
                {(settings?.store_email || 'info@bjsluxe.com') && (
                  <li>
                    <a href={`mailto:${settings?.store_email || 'info@bjsluxe.com'}`} className="footer__link" style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="var(--color-gold)" strokeWidth="1.5">
